...
Actualmente me encuentro cursando un Proyecto de Investigación Estudiantil, y es dentro de éste contexto que es del interés del equipo ir conociendo los aportes al desarrollo territorial de las empresas PYMES del Uruguay. ¿Cómo se constituyen? ¿Cómo y cuánto participan de la actividad económica? ¿Está sujeta a la situación socio-educativa del país?
...
![](pymes_files/figure-html/pct-faltantes-1.png){.absolute top="340" left="0" width="450" height="350"} ![](pymes_files/figure-html/pct-faltantes-sin-sector-1.png){.absolute top="340" right="50" width="450" height="350"} ---
